...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('dashboard_asset/assets') }}/bundles/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
    <!-- Template CSS -->
...
<body>
    ...
    <!-- JS Libraies -->
    <script src="{{ asset('dashboard_asset/assets') }}/bundles/datatables/datatables.min.js"></script>
    <script
        src="{{ asset('dashboard_asset/assets') }}/bundles/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js">
    </script>
